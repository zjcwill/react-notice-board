...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React.createElement("div", null, React.createElement(Wrapper, Object.assign({}, this.props), !hideBrand && React.createElement(LogoImg, {
      src: IMG_BRAND
    }), React.createElement(Content, Object.assign({}, this.props, {
      animation: this.stepLen > 2 ? this.scrollKeyFrames : null,
      duration: this.duration
    }), dataSource.map(function (item, index) {
      return React.createElement(Text, Object.assign({}, _this2.props, {
  ...
  _createClass(NoticeBoard, [{
    ...
    get: function get() {
      ...
      if (keyframesValue) {
        return styled.keyframes(_templateObject6(), keyframesValue);
      }
