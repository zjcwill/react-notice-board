...
var LogoImg = styled.img(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  width: 31px;\n  height: 14px;\n  margin: auto 12px auto 16px;\n"], ["\n  width: 31px;\n  height: 14px;\n  margin: auto 12px auto 16px;\n"])));
...
var ExtraWrapper = styled.div(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  float: right;\n  display: flex;\n  align-items: center;\n"], ["\n  float: right;\n  display: flex;\n  align-items: center;\n"])));
var NoticeBoard = /** @class */ (function (_super) {
    ...
    Object.defineProperty(NoticeBoard.prototype, "scrollKeyFrames", {
        get: function () {
            ...
            if (keyframesValue) {
                return keyframes(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n        ", "\n      "], ["\n        ", "\n      "])), keyframesValue);
            }
            return null;
        },
        enumerable: true,
    ...
    NoticeBoard.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement(Wrapper, __assign({}, this.props),
                React.createElement(LogoImg, { src: IMG_LOGO }),
                React.createElement(Content, __assign({}, this.props, { animation: this.scrollKeyFrames, duration: this.duration }), dataSource.map(function (item, index) { return (React.createElement(Text, __assign({}, _this.props, { key: index + "-" + item }), item)); })),
                extra && React.createElement(ExtraWrapper, null, extra))));
    };
